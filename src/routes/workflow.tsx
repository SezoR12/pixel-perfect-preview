  ...
  const stages = [
    {
      ...
      step: "01",
      icon: Cpu,
      title: "Multi-Vector AI Matchmaking & Discovery",
      badge: "FastAPI • PyTorch AI Node",
      path: "/ml-analytics",
      action: "Launch Intelligence Sandbox",
      desc: "Suppliers list verified physical product catalogs (/products) while institutional buyers inject structured purchasing inquiries (/demands). Our proprietary Random Forest & XGBoost algorithms evaluate spot ledgers across Price, Geographical Geo-Risk, Urgency, and KYC permissions.",
