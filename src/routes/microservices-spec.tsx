...
function MicroservicesSpecPage() {
  const services = [
    ...
    {
      id: "ai-ml-service",
      name: "AI / ML Intelligence Service",
      icon: Cpu,
      tech: "FastAPI • Python XGBoost • PyTorch LSTM",
      port: ":8005",
      repo: "backend/microservices/ai_ml_service/",
      desc: "Executes weighted multi-vector counterparty matching, 30-day LSTM commodity price predictions, and regional corridor demand forecasting.",
